              ...
              child: Stack(
                ...
                Positioned(
                  ...
                  child: Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.white,
                        borderRadius: BorderRadius.circular(isJumping ? 6 : 3),
                        boxShadow: [
                          BoxShadow(
                ...
                Positioned(
                  ...
                  child: Transform.rotate(
                    ...
                    child: Container(
                      ...
                      height: 6,
                      decoration: BoxDecoration(
                        color: hasSpeedBoost ? Colors.amber[600] : Colors.deepPurple[600],
                        borderRadius: BorderRadius.circular(3),
                        boxShadow: [
                          BoxShadow(
                ...
                Positioned(
                  ...
                  child: Transform.translate(
                    offset: Offset(0, isJumping ? 8 : 3 * animationController.value),
                    child: Container(
                      width: 6,
                      height: isJumping ? 12 : 15,
                      decoration: BoxDecoration(
                        color: hasSpeedBoost ? Colors.amber[700] : Colors.deepPurple[700],
                        borderRadius: BorderRadius.circular(3),
                        boxShadow: [
                          BoxShadow(
                            color: Colors.black.withOpacity(0.2),
